...
export default function AddProductModal(props) {
  ...
  const handleSaveData = async () => {
    ...
    try {
      ...
      const profileImageLink = await Storage.get(`product/${productId}.png`);
      ...
      await DataStore.save(
        Product.copyOf(original, (updated) => {
          ...
          updated.description = productData.description;
          updated.unitsPerPackage = parseInt(productData.unitsPerPackage);
          updated.packagesPerPallets = parseInt(productData.packagesPerPallets);
          updated.code = productData.productCode;
          updated.image = profileImageLink;
        })
      );
      setIsLoading(false);
