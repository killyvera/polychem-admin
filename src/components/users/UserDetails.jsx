...
export default function UserDetails({ userData }) {
  ...
  const userDetails = [
    ...
    {
      phone: user
        ? searchAttr("phone_number", user)
        : "Asignar Número Telefonico",
    },
    ...
    {
      departamento: user
        ? searchAttr("custom:departamento", user)
      ...
      >
        <Box sx={style}>
          ...
          <Typography>
            {" "}
            <b>Perfil: </b>
            {userDetails[3].perfil}
          </Typography>
          <Typography>
            {" "}
            <b>Cargo: </b>
            {userDetails[4].puesto}
          </Typography>
          <Typography>
            {" "}
            <b>Departamento: </b>
            {userDetails[5].departamento}
          </Typography>
          <Typography>
            {" "}
            <b>Número Móvil: </b>
